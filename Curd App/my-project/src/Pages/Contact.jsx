...
const Contact = () => {
  return (
    <div>
      <Navbar/>
            {/* <h1 className='text-3xl font-normal text-center'>This is Contact Page</h1> */}
            <div>
      ...
      <div class="-m-8 flex flex-wrap items-center justify-between">
        <div class="w-auto p-8">
          <a href="#">
            <div class="inline-flex items-center">
              ...
              <span class="ml-4 text-lg font-bold">Logo </span>
            </div>
          </a>
        </div>
        <div class="w-auto p-8">
          <ul class="-m-5 flex flex-wrap items-center">
            <li class="p-5">
              <a class="font-medium text-gray-600 hover:text-gray-700" href="../PrivacyPolicy">
              Privacy Policy
              </a>
            </li>
            <li class="p-5">
        ...
        <div class="w-auto p-8">
          <div class="-m-1.5 flex flex-wrap">
            ...
            <div class="w-auto p-1.5">
              <a href="https://www.instagram.com/accounts/login/" target='_self'>
                <div class="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                  <svg
                    width="16"
                    height="15"
